...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .content-wrapper { margin: 0 !important; padding: 0 !important; width: 100% !important; background-color: white !important; overflow: visible !important; height: auto !important; }
            ...
            .table-custom-wrapper { border: none !important; border-radius: 0 !important; }
            .table thead th { border-bottom: 2px solid #000 !important; background: transparent !important; color: #000 !important; }
            .table td { border-bottom: 1px solid #ddd !important; }
            .container-fluid { padding: 0 !important; }
            .badge { border: 1px solid #000 !important; color: #000 !important; background: transparent !important; }
            .stat-card { border: 1px solid #ddd !important; }
            /* Force background colors to print if user has the setting enabled */
            ...
            <div class="container-fluid p-4">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
                    ...
                    <div class="d-flex flex-wrap gap-2 filter-section">
                        ...
                        <button onclick="window.print()" class="btn btn-brand btn-print shadow-sm px-3 fw-semibold rounded-3">
                ...
                <div class="row mb-4">
                    <div class="col-md-3 mb-3 mb-md-0">
                        <div class="card stat-card border-0 shadow-sm h-100 bg-white border-success border border-primary-subtle">
                            <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                                <div class="icon-box bg-white rounded-circle text-primary me-3 shadow-sm">
                    ...
                    <div class="col-md-3 mb-3 mb-md-0">
                        <div class="card stat-card border-0 shadow-sm h-100 bg-white border-success border border-success-subtle">
                            <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                                <div class="icon-box bg-white rounded-circle text-success me-3 shadow-sm">
                    ...
                    <div class="col-md-3 mb-3 mb-md-0">
                        <div class="card stat-card border-0 shadow-sm h-100 bg-white border-success border border-info-subtle">
                            <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                                <div class="icon-box bg-white rounded-circle text-info me-3 shadow-sm">
                    ...
                    <div class="col-md-3">
                        <div class="card stat-card border-0 shadow-sm h-100 bg-white border-success border border-warning-subtle">
                            <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                                <div class="icon-box bg-white rounded-circle text-warning me-3 shadow-sm">
