...
$query = "SELECT r.request_id, r.student_id, r.duration_hours, CONCAT(s.first_name, ' ', s.last_name) AS full_name, i.item_name, i.item_id, r.request_date 
          FROM requests r
                                            ...
                                            <?php foreach ($requests as $row): ?>
                                                <tr>
                                                    ...
                                                    <td class="py-3">
                                                        ...
                                                        <span class="badge bg-light text-secondary border px-2 py-1 mt-1 font-monospace"> <?php echo htmlspecialchars($row['student_id']); ?></span>
                                                    </td>
                                                    <td class="py-3">
                                                    ...
                                                    <td class="py-3">
                                                        <span class="badge bg-light text-dark border px-2 py-1 font-monospace shadow-sm">
                                                            ...
                                                            <?php echo htmlspecialchars($row['duration_hours']); ?> Hours
                                                        </span>
                                                    </td>
