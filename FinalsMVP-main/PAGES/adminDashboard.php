...
<head>
    ...
    <style>
        ...
        .table-custom-wrapper { 
            ...
            min-height: 280px; /* Guarantees enough vertical space for the dropdown */
        }
            ...
            <nav class="main-header navbar navbar-expand navbar-dark border-bottom-0 shadow-sm w-100 m-0">
                <div class="container-fluid">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item d-none d-sm-inline-block ms-2"><span class="nav-link font-weight-bold text-light p-0" style="font-size: 1.1rem;">Admin Dashboard</span></li>
                    </ul>
                </div>
            </nav>
